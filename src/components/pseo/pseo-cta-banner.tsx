    ...
    <section className="py-12">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-lilac/10 via-orchid/5 to-skyward/10 border border-lilac/20 p-8 md:p-12">
        <div className="relative flex flex-col items-center text-center max-w-2xl mx-auto">
          <h2 className="font-signal text-2xl md:text-3xl font-semibold mb-3">{heading}</h2>
          {description && (
        ...
        <div className="absolute top-0 right-0 size-64 bg-gradient-to-bl from-lilac/10 to-transparent rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
        <div className="absolute bottom-0 left-0 size-48 bg-gradient-to-tr from-skyward/10 to-transparent rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
      </div>
    </section>
  )
}
