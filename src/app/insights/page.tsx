...
export default async function InsightsHub() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 py-20 pt-32">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="font-signal font-semibold text-4xl md:text-6xl mb-6 text-lilac">
              Insights Hub
            </h1>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="font-signal font-semibold text-3xl mb-4">Explore by Category</h2>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-x-3 mb-3">
                    ...
                    >
                      <IconComponent className="size-5" style={{ color: category.color }} />
                    </div>
        ...
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-12">
              <div>
                <h2 className="font-signal font-semibold text-3xl mb-4">Featured Articles</h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-12">
            <div>
              <h2 className="font-signal font-semibold text-3xl mb-4">Latest Insights</h2>
              <p className="text-muted-foreground">
      ...
      {featuredResources.length > 0 && (
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-12">
              <div>
                <h2 className="font-signal font-semibold text-3xl mb-4">Featured Resources</h2>
                <p className="text-muted-foreground">
