...
const services = [
  {
    ...
    icon: <Mic2 className="size-6 text-white" />,
    href: "/speaking",
    features: [
      ...
      <section className="relative py-32 pt-40 overflow-hidden bg-gradient-to-br from-lilac/10 via-background to-orchid/10">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h1 className="mx-auto max-w-4xl text-balance text-4xl font-semibold text-foreground lg:text-6xl mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-3xl font-semibold text-lilac mb-2">{stat.value}</div>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="h-full bg-card backdrop-blur-sm border border-border rounded-2xl p-8 hover:bg-card/50 transition-all duration-300 hover:shadow-2xl hover:scale-105">
                  ...
                  <ul className="gap-y-3 mb-8">
                    {service.features.map((feature) => (
                      <li key={feature} className="flex items-center gap-3 text-muted-foreground">
                        <div className="size-1.5 rounded-full bg-lilac" />
                        {feature}
                      </li>
                    ))}
                  </ul>
