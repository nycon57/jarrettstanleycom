...
function useResourcesPageClientView() {
    ...
    <main className="flex min-h-screen flex-col">
      ...
      <section className="relative py-32 overflow-hidden bg-gradient-to-br from-lilac/10 via-background to-orchid/10">
        <m.div 
          ...
          className="absolute top-1/4 left-10 size-32 bg-lilac/10 rounded-full blur-2xl"
        />
        <m.div 
          animate={{ 
            y: [20, -20, 20],
          ...
          className="absolute bottom-1/4 right-10 size-40 bg-orchid/10 rounded-full blur-2xl"
        />
        <div className="container mx-auto px-4 text-center relative">
          ...
          >
            <div className="relative">
              <IconSearch className="absolute left-4 top-1/2 transform -translate-y-1/2 size-5 text-muted-foreground" />
              <input
                type="text"
              ...
              {featuredResources.map((resource, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    >
                      View Resource <ArrowRight className="size-4 ml-1" />
                    </m.div>
                  </div>
                </m.div>
              ))}
            ...
            {filteredResources.map((resource, index) => (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  {resource.featured && (
                    <IconStar className="size-5 text-orange-500 fill-current" />
                  )}
                </div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {resource.tags.slice(0, 3).map((tag) => (
                    <span key={`${resource.id}-${tag}`} className="bg-muted text-muted-foreground px-2 py-1 rounded text-xs">
                      {tag}
                    </span>
                  ))}
                </div>
                <m.div 
                  ...
                  className="flex items-center text-lilac text-sm font-medium"
                >
                  Access Resource <ArrowRight className="size-4 ml-1" />
                </m.div>
                </div>
              </m.div>
            ))}
...
export default function ResourcesPageClient() {
  return useResourcesPageClientView();
}
