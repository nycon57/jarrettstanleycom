...
const GRID_COLUMNS = Array.from({ length: 12 }, (_, position) => ({
  id: `grid-column-${position + 1}`,
  label: position + 1,
}));

function useStyleGuidePageClientView() {
              ...
              <CardContent>
                <div className="flex justify-center">
                  <div className="relative">
                    ...
                    <div className="relative size-16 bg-lilac rounded-full" />
                  </div>
                </div>
              </CardContent>
            </Card>
...
export default function StyleGuidePageClient() {
  return useStyleGuidePageClientView();
}
